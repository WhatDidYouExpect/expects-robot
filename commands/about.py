...
class AboutCommands(commands.Cog):
    ...
    async def bot_credits(self, ctx):
        ...
        embed1.add_field(inline=False, name="People", value="[**whatdidyouexpect**](https://whatdidyouexpect.xyz) - Main bot developer\n[**Nikolans-Robot-Rewrite**](https://github.com/nikolan123/nikolans-robot-rewrite/tree/main) - took this command and the song command")
        embed1.add_field(inline=False, name="Links", value=f"[Github Repo](https://github.com/whatdidyouexpect/expects-robot)")
        # second page
        embed2 = discord.Embed(title='Computers', description="computer", color=0x54db8d)
    ...
    async def bot_info(self, ctx):
        ...
        async def contributing_callback(interaction):
            ...
            embed = discord.Embed(color=discord.Color.dark_teal(), title="Contributing (nikolans robot)", description="Anyone is able to contribute to the bot, as it is fully open-source.")
        ...
        embed = discord.Embed(title="expect's robot", description="A multifunctional Discord bot.\nNo license! because i dont care!", thumbnail=str(self.bot.user.avatar.url), color=discord.Color.dark_gold())
